...
esp_err_t esp_ble_mesh_set_scan_callback(esp_ble_gap_event_fn cb, void* context)
{
    ...
    msg.sig = BTC_SIG_API_CALL;
    msg.pid = BTC_PID_PROV;
    msg.act = BTC_BLE_MESH_ACT_SET_BLE_SCAN_CALLBACK;

    arg.mesh_set_ble_callback.cb = cb;
    arg.mesh_set_ble_callback.context = context;
...
esp_err_t esp_ble_mesh_set_advertise_callback(esp_ble_gap_event_fn cb, void* context)
{
    ...
    msg.sig = BTC_SIG_API_CALL;
    msg.pid = BTC_PID_PROV;
    msg.act = BTC_BLE_MESH_ACT_SET_BLE_ADV_CALLBACK;
...
esp_err_t esp_ble_mesh_resume_scan()
{
    ...
    msg.sig = BTC_SIG_API_CALL;
    msg.pid = BTC_PID_PROV;
    msg.act = BTC_BLE_MESH_BLE_RESUME_SCAN;
